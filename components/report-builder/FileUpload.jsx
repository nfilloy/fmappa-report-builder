...
export const FileUpload = memo(function FileUpload({
  ...
  return (
    <div className={cn("flex flex-col gap-3", fill && "h-full")}>
      <label
        className={cn(
          "group relative flex min-h-44 min-w-0 cursor-pointer flex-col items-center justify-center overflow-hidden rounded-2xl border border-dashed border-border bg-secondary/40 px-5 py-8 text-center transition hover:border-primary hover:bg-accent/40 sm:px-6",
          fill && "flex-1",
        )}
      >
        <span
