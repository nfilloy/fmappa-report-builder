...
// Relats' corporate red, extracted from public Relats brand materials
// (relats.com). Used as the default report accent because the deliverable is
// client-branded for Relats. No official Relats brand kit was provided, so an
// uploaded client logo takes precedence and re-derives the accent from it.
export const RELATS_RED = "#b91c1c";
