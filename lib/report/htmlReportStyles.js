export const HTML_REPORT_STYLES = `
  * { box-sizing: border-box; }
  ...
  .report-toc {
    ...
    margin: 0 0 32px;
    padding: 20px 22px;
    /* Page 1 is strictly the cover + this "Included sections" index: force the
       first content section onto page 2 so a short report never bleeds the
       executive summary onto the cover page. Honoured by the Playwright PDF
       (paged media); inert in the continuous on-screen scroll preview. */
    break-after: page;
  }
  .report-toc h2 {
    color: #18181b;
  ...
  .report-editable:hover {
    background: color-mix(in srgb, var(--report-accent, #041282) 6%, #ffffff);
    box-shadow: 0 0 0 1px color-mix(in srgb, var(--report-accent, #041282) 38%, transparent);
    cursor: text;
  }
  ...
  .report-editable:focus::after {
    background: var(--report-accent, #041282);
    border-radius: 999px;
    box-shadow: 0 4px 10px -4px color-mix(in srgb, var(--report-accent, #041282) 60%, transparent);
    color: #ffffff;
  ...
  .report-editable:focus {
    ...
    box-shadow: 0 0 0 2px var(--report-accent, #041282),
      0 6px 18px -10px color-mix(in srgb, var(--report-accent, #041282) 55%, transparent);
  }
  .report-editable:focus::after {
    content: "Editing";
  }
